                ...
                <div className="pl-9 flex flex-col gap-1">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={cn(
                        "text-[11px] font-medium px-2 py-0.5 rounded-full border border-transparent transition-colors cursor-default",
                        "hover:bg-opacity-100 dark:hover:bg-opacity-100",
                        invoice.urgency === "High" ? "text-[#444746] dark:text-[#bdc1c6] hover:bg-red-500/15 dark:hover:bg-red-500/20" :
                        invoice.urgency === "Medium" ? "text-[#444746] dark:text-[#bdc1c6] hover:bg-amber-500/15 dark:hover:bg-amber-500/20" :
                        "text-[#444746] dark:text-[#bdc1c6] hover:bg-slate-500/15 dark:hover:bg-slate-500/20",
                        isSelected && invoice.urgency !== "High" && "hover:bg-black/10 dark:hover:bg-white/10"
                      )}>
                        Due: {invoice.dateDue}
                      </span>
                    </div>
